...
class WelcomeScene extends Phaser.Scene {
    ...
    create() {
        ...
        // Animated waveforms in background
    ...
    createWaveforms() {
        ...
        // Store for animation
        this.waveGraphics = graphics;
        this.waveTime = 0;
        
        // Create multiple wave lines
        this.waves = [
            { y: height * 0.15, amplitude: 15, frequency: 0.02, speed: 1.5, alpha: 0.15 },
            { y: height * 0.85, amplitude: 20, frequency: 0.015, speed: 1.2, alpha: 0.12 },
            { y: height * 0.5, amplitude: 10, frequency: 0.025, speed: 2.0, alpha: 0.08 }
        ];
    }
    ...
    update(time, delta) {
        ...
        this.waves.forEach(wave => {
            this.waveGraphics.lineStyle(2, 0x00ffff, wave.alpha);
            this.waveGraphics.beginPath();
            
            for (let x = 0; x <= width; x += 5) {
                const y = wave.y + Math.sin(x * wave.frequency + this.waveTime * wave.speed) * wave.amplitude;
                if (x === 0) {
...
class TrainingScene extends Phaser.Scene {
    ...
    create() {
        ...
        this.skipButton = this.createButton(width - 140, 20, "I don't need training", 140, 30, () => {
            this.sound.play('click');
...
class GameScene extends Phaser.Scene {
    ...
    createWaveforms() {
        ...
        this.waves = [
            { y: height * 0.08, amplitude: 10, frequency: 0.02, speed: 1.5, alpha: 0.1 },
            { y: height * 0.92, amplitude: 12, frequency: 0.018, speed: 1.2, alpha: 0.08 }
        ];
    }
    ...
    update(time, delta) {
        ...
        // Update waveforms
        this.updateWaveforms(time, delta);
